...
- Adding a country to the spread chart? It's two touchpoints, not a
  ...
  SPREAD_COUNTRIES (src/constants.js in the yield-curve-react repo).
  SpreadChart derives its traces, colours, title, y-axis fit and notices
  from that list — see docs/spread-chart.md.
